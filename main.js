...
function somarLinhaD() {
  ...
  const resultadoD = [d1, d2, d3, d4, d5];  
         

    document.getElementById('resultadoD').innerText = (Math.min(...resultadoD));
...
function somarLinhaE() {
    ...
    const resultadoE = [e1, e2, e3, e4, e5];

    document.getElementById('resultadoE').innerText = (Math.min(...resultadoE));
...
function somarLinhaI() {
    const i2 = parseFloat((document.getElementById('i2').value || '0').replace('%', '')) / 100;
    const i3 = parseFloat((document.getElementById('i3').value || '0').replace('%', '')) / 100;
    const i4 = parseFloat((document.getElementById('i4').value || '0').replace('%', '')) / 100;
    const i5 = parseFloat((document.getElementById('i5').value || '0').replace('%', '')) / 100;

    const resultadoI = i2 + i3 + i4 + i5;
    const resultadoFormatado = (resultadoI * 100).toFixed(2) + '%';
...
function somarLinhaJ() {
    const j2 = parseFloat((document.getElementById('j2').value || '0').replace('%', '')) / 100;
    const j3 = parseFloat((document.getElementById('j3').value || '0').replace('%', '')) / 100;
    const j4 = parseFloat((document.getElementById('j4').value || '0').replace('%', '')) / 100;
    const j5 = parseFloat((document.getElementById('j5').value || '0').replace('%', '')) / 100;
    

    const resultadoJ = j2 + j3 + j4 + j5 ;
    const resultadoFormatado = (resultadoJ * 100).toFixed(2) + '%';
...
function calcularD1menosD2() {
    ...
    const porcentagem = resultado * 100;

    // Adiciona o resultado ao elemento com o ID '12'
    document.getElementById('i2').value = porcentagem.toFixed(2);
